...
error           gpio_enable             (const gpio_pin_t, gpio_mode_t mode);

error           gpio_settings           (const gpio_pin_t,
                                         const u8 speed,
                                         const u8 pull_up_down,
                                         const u8 push_pull_open_drain);

error           gpio_set_speed          (const gpio_pin_t, const u8 speed);
...
error           gpio_attach_exti        (const gpio_pin_t pin, void *(func)(void));
